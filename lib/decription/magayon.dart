...
class MagayonDescription extends StatelessWidget {
  const MagayonDescription({
    super.key,
    required this.width,
              ...
              child: Column(
                ...
                children: [
                  ResultCircleAvatar(
                    height: height,
                    imgPath: (input == 'MPF')
                        ? 'assets/imgs/magayon.png'
                        : 'assets/imgs/magayon_shell.png',
                  ),
                  Text(
                    widget.label!,
                    style: t1(),
                  ...
                  Text(
                    "NSIC Registration No: NSIC 2000 Pl-05",
                    style: t2(),
                  ),
                ],
              ),
                      ...
                      views: [
                        ...
                        Padding(
                          ...
                          child: Align(
                            ...
                            child: Column(
                              children: [
                                charContent(c1: 'Weight', c2: '37.47 g'),
                                const Divider(color: white),
                                charContent(c1: 'Length', c2: '58.11 mm'),
                                const Divider(color: white),
                                charContent(c1: 'Width', c2: '27.11 mm'),
                                const Divider(color: white),
                          ...
                          child: Align(
                            ...
                            child: Column(
                              children: [
                                ...
                                const Divider(color: white),
                                charContent(c1: 'Weight', c2: '24.34 mm'),
                                const Divider(color: white),
                                charContent(c1: 'Thickness', c2: '4.43 mm'),
                                const Divider(color: white),
                                charContent(
                                    c1: '% Based on Fruit Weight', c2: '64.5%'),
                                const Divider(color: white),
                              ],
                            ),
                          ),
                        ...
                        Padding(
                          ...
                          child: Align(
                            ...
                            child: Column(
                              children: [
                                charContent(c1: 'Weight', c2: '8.65 mm'),
                                const Divider(color: white),
                                charContent(c1: 'Thickness', c2: '2.37 mm'),
                                const Divider(color: white),
                                charContent(
                        ...
                        Padding(
                          ...
                          child: Align(
                            ...
                            child: Column(
                              children: [
                                charContent(c1: 'Weight', c2: '3.10 g'),
                                const Divider(color: white),
